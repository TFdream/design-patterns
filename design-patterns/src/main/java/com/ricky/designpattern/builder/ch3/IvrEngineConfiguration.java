...
public class IvrEngineConfiguration {
	...
	private final String checkUpdateNetworkType; //网络类型：2G/3G/4G/Wifi
	...
	public String getCheckUpdateNetworkType() {
	...
	public static class Builder {
		...
		private String checkUpdateNetworkType;
		...
		public Builder checkUpdateNetworkType(String checkUpdateNetworkType) {
		...
		private void initEmptyFieldsWithDefaultValues() {
			...
			if(StringUtils.isEmpty(checkUpdateNetworkType)){
				checkUpdateNetworkType = "2G/3G/4G/Wifi";
			}
		}
